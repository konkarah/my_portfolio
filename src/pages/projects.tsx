...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Lawrence Thindi - Software Developer Portfolio"
        description="Explore a collection of projects by Lawrence Thindi, a seasoned Software Developer. From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
        canonical={`${siteMetadata.siteUrl}/projects`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/projects`,
          title: "Discover Projects by Lawrence Thindi - Software Developer",
          description:
